    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.logoContainer}>
                <Image source={require("../../assets/guide.png")} style={styles.imageContainer} />
            </View>
            <View style={styles.pupilTextContentContainer}>
                <Text style={styles.pupil}>Guides</Text>
                <Text style={styles.pupilTextContent}>Share your expertise, inspire others, and uplift the community.</Text>
            </View>
